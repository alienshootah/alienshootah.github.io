...
function validate() {
    ...
    if (a == 0) {
        ...
        // calculate th result using (-b +- sqr(b*2 - 4ac)) / 2a
        var x1 = (-b - Math.sqrt(Math.pow(b, 2) - 4 * a * c)) / (2 * a);
        var x2 = (-b + Math.sqrt(Math.pow(b, 2) - 4 * a * c)) / (2 * a);
        outputText = "For the equation <strong>" + (a == 1 ? "" : a) + "x\u00B2 + " 
        + (b == 1 ? "" : b) + "x + " + c + " = 0<strong>, x can equal <strong>" + x1 + "</strong> or <strong>" + x2 + "</strong>";
        "</strong>";
    }
