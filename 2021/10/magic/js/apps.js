...
const shBtn = document.querySelector(".login-text");
shField = document.querySelector(".login-field-pass");
if(shBtn) {
  shBtn.addEventListener("click", function() {
    if (shField.type === "password") {
      shField.type = "text";
      shBtn.textContent = "Скрыть";
    } else {
      shField.type = "password";
      shBtn.textContent = "Показать";
    }
  });
}
