...
<div id="content" class="main-right"><?php echo $content_top; ?>
    ...
    <div id="content-order">
        <h1 class="btn-main"><a href="/">SIBITM.RU</a></h1>
        ...
        <div class="order">
            <div class="text-left">
                <img src="catalog/view/theme/seonix/image/sibitm-logo.png" alt="" style="width: 50%; display: block; margin: 0 auto 10px;">
                <p>Сломался гибридный лазер? Не работает аппарат для коррекции фигуры? Нужно заправить картридж или заменить расходные материалы? По этим и другим вопросам, связанным с работой косметологического и медицинского оборудования, обращайтесь в СиБиТМ!</p>
