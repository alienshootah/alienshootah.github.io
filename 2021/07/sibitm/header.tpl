...
<script id="ISDEKscript" src="https://sibitm.ru/pvzwidget/widget/widjet.js"></script>
        ...
        <div class="wrapper">
            <div class="header__middle">
                <div class="header__logo">
                    <a href="/">
                        <img src="catalog/view/theme/seonix/image/sibitm-logo.png" alt="logo">
                    </a>
                </div>
                ...
                <div class="header__bottom">
                        ...
                        <div class="box">
                          ...
                          <div class="box-content">
                            ...
                            <ul class="box-category__additional">
                                <li>
                                    <a href="https://sibitm.ru/index.php?route=citycard/application">
                    ...
                    <div class="header__nav">
                        <ul>
                            ...
                            <li>
                                <!-- <a href="https://sibitm.ru/index.php?route=citycard/application"><img src="catalog/view/theme/seonix/image/ico-support.svg" alt="">Вызвать мастера</a> -->
