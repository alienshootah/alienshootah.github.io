...
<head>
    ...
    <title>Rejestracja 1 - Nauka</title>
                ...
                <div class="row rej-body">
                    <div class="col-12">
                        ...
                        <form action="/" class="rej-form">
                            ...
                            <input type="password" class="rej-field rej-field-red" placeholder="Haslo">
                            ...
                            <p class="rej-alert">Hasło musi zawierać więcej niż 6 znaków</p>
                        </form>
                    </div>
                </div>
            </div>
