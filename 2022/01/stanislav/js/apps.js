...
const proposeSlider = new Swiper('.propose-slider', {
    ...
    loop: true,
    navigation: {
      nextEl: '.propose-arrow-right',
      prevEl: '.propose-arrow-left',
    },
});
...
const clinikSlider = new Swiper('.clinik-list', {
    ...
    navigation: {
      ...
      prevEl: '.clinik-arrow-left',
    },
});

const usefulSlider = new Swiper('.useful-list', {
    slidesPerView: 1,
    spaceBetween: 95,
    navigation: {
...
const confidenceSlider = new Swiper('.confidence-list', {
    slidesPerView: 1,
    spaceBetween: 180,
    loop: true,
    navigation: {
      nextEl: '.confidence-arrow-right',
